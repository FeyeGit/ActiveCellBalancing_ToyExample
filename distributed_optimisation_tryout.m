...
%             [u_opt(:,n),fval,exitflag,output] = quadprog((H+H')/2+(0.1*eye(size((H+H')/2,1))),F',[Aineq],[bineq],[],[],lb,ub,[],options);      %
            [u_opt(:,n),fval,exitflag,output] = quadprog((H+H')/2+diag(repmat([0 0],1,ending)),F',[Aineq],[bineq],[],[],lb,ub,[],options);      %
        elseif iter==1
            [u_opt(:,n),fval,exitflag,output] = quadprog((H+H')/2,F',[Aineq],[bineq],[],[],lb,ub,[],options);      %
        elseif mean(Merit_end)<0
            [u_opt(:,n),fval,exitflag,output] = quadprog((H+H')/2+0.8*eye(size((H+H')/2,1)),F',[Aineq],[bineq],[],[],lb,ub,[],options);      %
        end
