function [phi,gamma,Cm,Dm,Xiu] = predictMatrix_constant_LTV_N_lin_full(a,ending,n,C0_varied,AB_var,D_var,A,B,D,x,alpha1,alpha0)
...
phi = sparse(zeros(ending*mA,mA));
gamma = sparse(zeros(ending*mA,ending*2));
Cm = sparse(zeros(ending,2*ending));
Dm = sparse(zeros(ending,2*ending));
